...
<section id="Miradormatters">
    ...
    <div class="explorePopUp" id="ExplorePopup">
      <div class="row">
        <div class="col col-12 col-md-6 explore-img-col">
          <div class="exploreimgBox">
            <img src="<?php echo get_template_directory_uri();?>/exports/ExploreSofa.png">
          </div>
        </div>        
        <div class="col col-12 col-md-6 explore-text-col">
          <div class="exploreText">
            <h2>Explore our new custom created sofa collection</h2>
            <p>Get your customised SOFA</p>

            <a href="<?php echo site_url() ?>/sofa/" class="btn btn-outline-dark waves-effect">Explore now</a>
          </div>
        </div>        
      </div><!-- eo row -->
      <div class="closeExplore" id="ExplorePopupClose">
        <span></span>
        <span></span>
      </div>
    </div>
