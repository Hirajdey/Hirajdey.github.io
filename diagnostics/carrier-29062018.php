  	...
  	<div id="tabs-1" class="diganosticsCont inner">
	  	...
	  	<div id="T4" class="diganosticsInnerContent">
	  		...
	  		<div class="diganosticsInnerText carrierInIndia px-2">
				<div class="row text-center">
					<div class="col-lg-12">
						<div class="row">
							...
							<div class="col-lg-2 mr-lg-5 col-md-3 col-sm-3">
				...
				<div class="row mx-1">
					<div class="col-lg-6">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4"><img class="img-fluid col-lg-12 mt-4 background-circle" src="images/critical-in-india-bottom.png" alt="career-screen-india" /></div>
					...
					<div class="col-lg-6">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4"><img class="img-fluid col-lg-12 mt-4 background-circle" src="images/critical-in-india-bottom1.png" alt="career-screen-india" /></div>
		...
		<div id="T5" class="diganosticsInnerContent">
			...
			<div class="diganosticsInnerText superiorTech hasBtn">
				...
				<div class="row border border-info text-center d-block d-sm-none mb-4">
