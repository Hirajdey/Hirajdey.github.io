	...
	<div ng-app="symposiumApp">
		<div ng-controller="symposiumCtrl">
			...
			<div class="container symposium">
				...
				<div class="row">
					<div class="col-md-24">
						<h1>Symposium on genomics on March 20, 2018 at MedGenome Foster City</h1><br>
					</div>
				</div>

				<div class="row row-eq-height">
					<div class="col-md-12 speach1">
						<b>Dr. Kasthuri Kannan</b>, Assistant Professor of Pathology, Investigator, Genome Technology Center (GTC) Core Labs, NYU Langone Health<br>
						<b>Topic:</b> Genomics of Pineoblastoma
					</div>
					<div class="col-md-12 speach1">
						<b>Dr. Rama Natarajan</b>, National Business Products Industry Professor in Diabetes Research, Professor and Chair, Department of Diabetes Complications and Metabolism, City of Hope Hospital<br>
						<b>Topic:</b> Epigenetic mechanisms underlying Diabetic complications and Metabolic Memory
					</div>
				</div>
