...
if(isset($_REQUEST['name']) && isset($_REQUEST['email']) && isset($_REQUEST['phone']) && isset($_REQUEST['city']) && isset($_REQUEST['organization'])) {
	...
	$_REQUEST['note'] = "Name: ".urldecode($_REQUEST['name'])."<br>"."Email: ".$_REQUEST['email']."<br>"."Phone: : ". $_REQUEST['phone']."<br>"."City: : ". $_REQUEST['city']."<br>"."Organization: : ". $_REQUEST['organization'];
