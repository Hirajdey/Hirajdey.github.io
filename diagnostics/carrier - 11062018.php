...
<div class="homeTab">
	<div class="wrapper">
  	...
  	<div id="tabs-1" class="diganosticsCont inner">
	  	...
	  	<div class="diganosticsInnerContent">
	  		<div class="heading">
	  			<span>Claria Carrier Screening</span>
	  		</div>
	  	...
	  	<div class="diganosticsInnerContent clariaVideo">
	  		<div class="heading">
	  			<span>Overview of Claria Career Screening</span>
	  		</div>
		  		...
		  		<div class="rightCont">	
		  			<div class="singleVideo">
						<div class="videoImage">
							<!--<img src="images/claria-single-video.jpg" alt="videos"/>-->
							<iframe width="530" height="315"
									src="https://www.youtube.com/embed/aKvur5hdz_M">
							</iframe>
						</div>
						<!--<div class="overlayBtn">
							<a href="javascript:;"><span class="bg"></span>
							<span class="txt">PLAY VIDEO</span></a>
						</div>-->
					</div>
		  		</div>
		  	</div>
	  	...
	  	<div class="diganosticsInnerContent">
	  		<div class="heading">
	  			<span>Carrier Screening is Critical in India</span>
	  		</div>
	  		<div class="diganosticsInnerText carrierInIndia">
	  			...
	  			<p>The unique ‘Claria Carrier screening Test’ is based on the Next Generation Sequencing (NGS) technology and leverages the Indian population genetic variant database created by Sir Ganga Ram Hospital over the last twenty years. Therefore enabling MedGenome to develop a highly focussed and cost effective test to screen for diseases and genetic variations that are very specific to Indian population. The Claria Carrier Screening provides you with : </p>
			  	<div class="leftCont">
			  		<div class="leftImg">
	  		...
	  		<div class="diganosticsInnerText superiorTech hasBtn">
				...
				<div class="superiorFeat">
					<div class="featureBlock">
						...
						<!--<a href="javascript:;">View Entire List</a>-->
					</div>
					<div class="featureBlock">
						<div class="topDiv">
					...
					<div class="featureBlock">
						...
						<!--<a class="active" href="javascript:;">Learn more</a>-->
					</div>
				</div>
		...
		<div class="diganosticsInnerContent">
	  	...
	  	<div class="diganosticsInnerContent">
	  		<div class="heading">
	  			<span>About Recessive Disorders</span>
	  		</div>
	  		<div class="diganosticsInnerText">
	  	...
	  	<div class="diganosticsInnerContent">
	  		...
	  		<div class="diganosticsInnerText bgcont">
		  		...
		  		<div class="individualDiv">
		  			...
		  			<p>A carrier, is a person that has inherited a recessive variant gene for a genetic trait or mutation but does not display that trait or show symptoms of the disease. Carriers are, however, able to pass the allele onto their offspring, who may then express the genetic if they inherit the recessive allele from both parents. The chance of two carriers having a child with the disease is 25%. This phenomenon is a direct result of the recessive nature of many genes</p>
		  		</div>
		  		<div class="individualDiv">
		  			<h3>Why screen for inherited genetic conditions?</h3>
		  			<p class="bold">Each individual harbours an average of 2.8 known severe recessive mutations.#</p>
		  			<p>&nbsp;</p>
		  			<p>Carriers are usually healthy or unaffected; but, they have a risk of passing on their genetic <br/> condition to their children. Traditionally, carrier <br/>screening has been offered to patients based on their ethnic background or family history. <br/>However, more than 80% of babies born with inherited genetic diseases have no known <br/>family history.*</p>
		  			<p>#  Bell CJ, et al. Carrier Testing For Severe Childhood Recessive Diseases by NGS. Sci Transl Med. 2011 Jan 12;3 (650:65ra4)<br/>*  Blythe and Farrell. Advances in the Diagnosis and Management of Cystic Fibrosis. Clinical Biochemistry. 1984</p>
		  		</div>
		  		<div class="individualDiv">
		  			<h3>Why trust the Claria Carrier Screening? </h3>
		  			<p>The Claria Carrier Screening detects for genetic variations, and diseases that are<br/>very specific to Indian population.The unique ‘Claria Carrier Screening is based on the Next-Generation Sequencing (NGS) technology<br/> and leverages the Indian population genetic variant database.</p>
