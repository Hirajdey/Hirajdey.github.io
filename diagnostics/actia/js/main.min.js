...
$("#clariaId").click(function () {
    ...
    else if(host == 'http://medgenome.staging.wpengine.com' || host == 'medgenome.staging.wpengine.com')
        window.location.href = "http://medgenome.staging.wpengine.com/diagnostics/index.php";
    else
...
$("#actiaId").click(function () {
    ...
    if(host == 'localhost')
        ...
        window.location.href = "http://medgenome.staging.wpengine.com/diagnostics/actia/cardio-genetic.php";
    else
...
$("#primaId").click(function () {
    ...
    if(host == 'localhost')
        ...
        window.location.href = "http://medgenome.staging.wpengine.com/diagnostics/prima/somatic-cancer.php";
    else
