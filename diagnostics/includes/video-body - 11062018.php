...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-6 col-md-8">
            <div class="thumbnail">
                <a href="<?php echo $video_link[$i];?>" target="_blank">
                    <img src="<?php echo $site_path;?>/images/press/videos/<?php echo $video_image[$i];?>" alt="Lights" style="width:100%">
                    <div class="caption">
        ...
        <!--<div class="col-xs-6 col-md-8">
            <div class="thumbnail">
                <a href="https://www.youtube.com/watch?v=ALpvLyiqMhU" target="_blank">
                    <img src="<?php /*echo $site_path;*/?>/images/video/vidhya.jpg" alt="Lights" style="width:100%">
                    <div class="caption">
                        <p><strong>Dr. Vidhya H Veldore, Principal Scientist, Oncology, Division, Medgenome</strong></p>
                    </div>
                </a>
            </div>
        </div>-->
