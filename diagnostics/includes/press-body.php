<div>
    ...
    <div id="search" class="container">
        ...
        <div class="row">
            <div class="col-md-12"><input type="text" class="form-control press-search-box" ng-model="search" placeholder="Enter the text for search"></div>
            <!--<h3 class="col-md-12 video"><a href="video.php" class="">Video</a></h3>-->
    ...
    <div class="container press year2016">
        ...
        <!-- Full News -->
            ...
            <tr class="news-description">
                ...
                <td colspan="3"><p ng-bind-html="title.description"></p></td>
            </tr>
                ...
                <td colspan="6">
                    ...
                    <div id='{{title.id}}pop' class="pop" style="display: none;">
                        <div class="row sub_news" ng-repeat="(key, subtitle) in title.subnews">
                            ...
                            <div class="col-xs-1 col-sm-2 col-md-24" ng-if="subtitle.pdf "><a href="{{ sitePath }}{{subtitle.pdf }}" target="_blank">{{ sitePath }}{{subtitle.pdf }}</a></div>
                        </div>
                    </div>
                </td>
            </tr>
