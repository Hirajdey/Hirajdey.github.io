...
<div class="management">
        ...
        <div class="wrapper about-wrapper-index visible-xs visible-sm visible-md visible-lg management">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="row modal-body">
                            <div class="col-md-6 management-image"><img alt="" src="leadership/management/{{photo}}" width="150px" height="150px"></div>
            ...
            <div class="container">
                ...
                <div class="col-xs-24 col-md-24 photo hvr-grow">
                    <img width="167px" height="157px" alt="Sam Santhosh" src="leadership/management/Sam.jpg" ng-click="detailedView('Sam.jpg','Sam Santhosh – Founder and Chairman','sam')">
                ...
                <div class="row top">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row left">
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Amitabha Chaudhuri" src="leadership/management/Amit.jpg" ng-click="detailedView('Amit.jpg','Dr. Amitabha Chaudhuri – VP, Research & Development','amit')">
										<span class="name"><br>Dr. Amitabha Chaudhuri <br><span class="designation"> VP, Research & Development</span>
                            </div>
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Michael Nemzek" src="leadership/management/Michael-Nemzek.jpg" ng-click="detailedView('Michael-Nemzek.jpg','Michael Nemzek – Chief Commercial Officer, USA','michael')">
                        ...
                        <div class="row">
                            <!-- Timothy J. Triche -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Timothy J. Triche" src="leadership/management/Timothy.jpg" ng-click="detailedView('Timothy.jpg','Dr. Timothy J. Triche – Laboratory Director','tim')">
										<span class="name"><br>Dr. Timothy J. Triche<br><span class="designation"> Laboratory Director </span>
                            </div>
                            <!-- Kamil Hamied -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Kamil Hamied" src="leadership/management/Kamil-Hamied.jpg" ng-click="detailedView('Kamil-Hamied.jpg','Kamil Hamied - International Business Development Consultant','kamil')">
                        ...
                        <div class="row">
                            <!-- Hiranjith -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Hiranjith G H" src="leadership/management/Hiran.jpg" ng-click="detailedView('Hiran.jpg','Hiranjith G H – Director, Corporate Planning, Marketing & Communications','hiran')">
										<span class="name"><br>Hiranjith G H <br><span class="designation"> Director, Corporate Planning, Marketing & Communications</span>
                            </div>
                            <!-- Tariq Arshad -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Tariq Arshad" src="leadership/management/Tariq-Arshad.png" ng-click="detailedView('Tariq-Arshad.png','Dr. Tariq Arshad – Chief Medical Officer (Immuno-Oncology)','tariq')">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row right">
                            <!-- Girish Mehta -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Girish Mehta" src="leadership/management/Girish-Mehta.png" ng-click="detailedView('Girish-Mehta.png','Girish Mehta – CEO (India)','grish')">
								<span class="name"><br>Girish Mehta <br> <span class="designation"> CEO (India)</span>
                            </div>

                            <!-- V L Ramprasad -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="V L Ramprasad" src="leadership/management/Ram.jpg" ng-click="detailedView('Ram.jpg','Dr. V L Ramprasad – COO','ram')">
                        ...
                        <div class="row">
                            <!-- Rohit Gupta -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Rohit Gupta" src="leadership/management/Rohit.jpg" ng-click="detailedView('Rohit.jpg','Dr. Rohit Gupta – CIO','rohit')">
								<span class="name"><br>Dr. Rohit Gupta <br><span class="designation"> CIO</span>
                            </div>
                            <!-- Surajit Chakrabartty -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Surajit Chakrabartty" src="leadership/management/Surajit.jpg" ng-click="detailedView('Surajit.jpg','Surajit Chakrabartty – CFO','surajit')">
                        ...
                        <div class="row">
                            <!-- Sanjay Kumar Sharma -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Sanjay Kumar Sharma" src="leadership/management/Sanjay.jpg" ng-click="detailedView('Sanjay.jpg','Sanjay Kumar Sharma – CCO','sanjay')">
								<span class="name"><br>Sanjay Kumar Sharma <br><span class="designation"> CCO</span>
                            </div>
                            <!-- Chirantan Bose -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" width="150px" height="150px"  alt="Chirantan Bose" src="leadership/management/Chirantan-Bose.jpg" ng-click="detailedView('Chirantan-Bose.jpg','Dr. Chirantan Bose – VP, Clinical Services','bose')">
                        ...
                        <div class="row">
                            <!-- Arati Khanna Gupta -->
                            <div class="col-xs-12 col-md-12 photo hvr-grow">
                                <img width="167px" height="157px" alt="Arati Khanna Gupta" src="leadership/management/Arati.jpg" ng-click="detailedView('Arati.jpg','Dr. Arati Khanna Gupta – VP, Research & Development (India)','arati')">
