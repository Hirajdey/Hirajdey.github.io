  	...
  	<div id="tabs-1" class="diganosticsCont inner">
	  	...
	  	<div class="diganosticsInnerContent">
	  		...
	  		<div class="diganosticsInnerText structuralAnomalies">
				...
				<div class="text-center chromosomal">
					<!-- first column -->
					<!--<div class="col-main col-lg ml-3 mr-4 mb-2">
						<div class="col-top">
							<div class="row top p-4">
								<div class="col-lg">

									<img src="images/superior-img1.png" class="rounded-circle" alt="Cinque Terre" width="236" height="236" style="border: 1px solid red;">
								</div>
							</div>
