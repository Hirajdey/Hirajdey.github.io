	...
	<div ng-app="symposiumApp">
		<div ng-controller="symposiumCtrl">
			...
			<div class="container symposium">
				...
				<div class="row">
					<div class="col-md-24">
						<h1>Symposium on NeuroGenomics on October 24, 2017 at MedGenome Foster City</h1><br>
					</div>
				</div>

				<div class="row row-eq-height">
					<div class="col-md-20 speach1">
						<b>Dr. William Byerley</b>, Professor Emeritus, UCSF School of Medicine, Scientific Council Member, University of California, San Francisco <br> <b>Topic:</b> Molecular Characterization of Rare Variants for Psychosis in Palau
						<br><b>Time:</b> 1:30 pm - 2:30 pm PST, October 24, 2017
					</div>
				</div>
