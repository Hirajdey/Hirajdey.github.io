	...
	<div ng-controller="oncopeptCtrl">
		<div class="container">
			...
			<div class="row top_links">
				...
				<div class="col-xs-24 col-sm-7 col-md-4"><a href="<?php echo $site_path;?>/oncopeptadditional.php?act=presentations" class="<?php if($_REQUEST['act'] == 'presentations') echo 'active';?>" ng-class="addClassPresentations()">Presentations</a></div>
				<div class="col-xs-24 col-sm-10 col-md-4"><a href="<?php echo $site_path;?>/oncopeptadditional.php?act=posters" class="<?php if($_REQUEST['act'] == 'posters') echo 'active';?>" ng-class="addClassPosters()">Posters</a></div>
				<div class="col-xs-24 col-sm-10 col-md-5"><a href="<?php echo $site_path;?>/oncopeptadditional.php?act=products" class="<?php if($_REQUEST['act'] == 'products') echo 'active';?>" ng-class="addClassProduct()">Product Brochures</a></div>
				<div class="col-xs-24 col-sm-7 col-md-3"><a href="<?php echo $site_path;?>/oncopeptadditional.php?act=videos" class="<?php if($_REQUEST['act'] == 'videos') echo 'active';?>" ng-class="addClassVideo()">Videos</a></div>
				<div class="col-xs-24 col-sm-10 col-md-4"><a href="<?php echo $site_path;?>/oncopeptadditional.php?act=papers" class="<?php if($_REQUEST['act'] == 'papers') echo 'active';?>" ng-class="addClassPapers()">White Papers</a></div>
				<div class="col-xs-24 col-sm-10 col-md-4"><a href="<?php echo $site_path;?>/oncopeptadditional.php?act=events#events" class="<?php if($_REQUEST['act'] == 'events') echo 'active';?>" ng-class="addClassEvent()">Events</a></div>
			</div>
		</div>
		<!-- Presentations -->
			<div class="container presentations" id="presentationsSection" style="display: none;">
				<?php include('oncopeptadditional/presentations.php');?>
			</div>
		...
		<div class="container posters" id="postersSection" style="display: none;">
			<?php include('oncopeptadditional/posters.php');?>
		</div>
		...
		<div class="container product" id="productsSection" style="display: none;">
			<?php include('oncopeptadditional/product.php');?>
		</div>
		...
		<div class="container video" id="videosSection" style="display: none;">
			<?php include('oncopeptadditional/video.php');?>
		</div>
		...
		<div class="container papers" id="papersSection" style="display: none;">
			<?php include('oncopeptadditional/white-papers.php');?>
		</div>
		...
		<div class="container event" id="eventsSection" style="display: none;">
			<?php include('oncopeptadditional/event.php');?>
		</div>
