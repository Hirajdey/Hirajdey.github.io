<?php require 'php-templates/header.php' ?>
	...
	<div class="g1-section " id="g1-section-1">
		<div class="g1-layout-inner">
			<h1>PHP Developer</h1>
			<h5><b>Location</b>: Bangalore / Chennai</h5><br>

			<br>
			<p class="text-justify"><b>Typical job responsibilities include but not restricted to:</b></p>
			<ul>
				<li>Experience in working with Web applications, and specialized in Open Source Software</li>
				<li>Hands-on experience in PHP 5.x, Open Source Frameworks (like CakePHP), MySQL and JavaScript</li>
				<li>Good knowledge in AJAX, jQuery, JavaScript, and XHTML</li>
				<li>Good knowledge in MySQL and similar RDBMS</li>
				<li>Experience in both front-end and back-end technologies</li>
			</ul>

			<br>
			<p class="text-justify"><b>Skill set:</b></p>
			<ul>
				<li>In-depth knowledge of PHP web development</li>
				<li>Very good in at least one front-end technology</li>
				<li>Good in at least one DB usage</li>
			</ul>
			<br>
			...
			<ul>
				...
				<li>B.E/ MCA – Graduates with 5+ years of experiences</li>
				<li>Domain: IT/ Life sciences / Healthcare</li>
			</ul>
			<br>
