	...
	<div class="container diseasemenugenelist" ng-controller="diseaseCtrl">
		...
		<div class="row disease_row">
			...
			while($row = $category->fetch_assoc()){	?>
				<div class="col-md-6 disease"><input type="radio" name="diseasename" ng-model="disease" value="<?php echo $row['name'];?>" ng-click="radioClick('<?php echo $site_path;?>');"> <?php echo $row['name'];?></div>
			<?php }
			?>
		</div>
		<div class="row disease_row">
		...
		<!-- Result -->
		<div class="table-responsive test-list-table">
