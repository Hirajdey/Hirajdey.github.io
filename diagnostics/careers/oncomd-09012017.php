...
<div class="research-wrp col-sm-24">
	<div class="half-col1 col-sm-12 col-xs-24">
		...
		<a class="btn btn-blk-trns" href="<?php echo $site_path;?>/oncomdresearch.php">Learn More</a>
	</div>
	<div class="half-col2 col-sm-12 col-xs-24">
		<h4>For Clinicians</h4>
		<p>Actionable Clinical Report</p>
		<a class="btn btn-blk-trns" href="<?php echo $site_path;?>/oncomdclinician.php">Learn More</a>
	</div>
	<div class="clear"></div>
</div>
<div class="clear"></div>
