...
<?php require 'php-templates/events-popup.php';?>
...
<div class="wrapper banner-section-index ">
	...
	<div class="homepage-slider-banner">
		<div class="container banner-content">
     		...
     		<div class="item active">
					  ...
					  <div class="banner1-text">
						   ...
						   <!--<div class="thirdline">CLIA certified, CAP accredited, ISO15189 compliant Next Generation Sequencing Lab in California</div>-->
							   <div class="thirdline">ISO15189 compliant Next Generation Sequencing Lab in California</div>
			...
			<!-- 4'th Liquid Biopsy Slide -->
			<div class="item">
				<a href="<?php echo $site_path;?>/liquidbiopsy.php" target="_blank"><img src="<?php echo $site_path;?>/img/slider/4-min.jpg" class="img-responsive banner hidden-xs"></a>
				<a href="<?php echo $site_path;?>/liquidbiopsy.php" target="_blank"><img src="<?php echo $site_path;?>/img/slider/M4-min.jpg" class="img-responsive banner visible-xs"></a>
					<!--<div class="banner1-text banner4-text">
					   <span>-->
							<!--<div>OncoTrack</div>
							<div>India’s first validated liquid biopsy</div>

							<div>Monitoring Cancer treatment</div>
							<div>now simplified</div>

						   <div><a class="scrollto" href="http://staging.medgenome.com/liquidbiopsy/" target="_blank">Know More</a></div>-->
					   <!--<div id="banner_content">
								<h1>OncoTrack</h1>
								<h3 id="tag">India’s first validated liquid biopsy</h3>

								<h3>Monitoring Cancer treatment <br>
								<span>now simplified</span></h3>

								</div>-->
							<!--<div class="thirdline banner4-text">MedGenome Singapore Announces Whole Genome Sequencing Grant Challenge for South East Asia </div>-->

					   <!--</span>
					</div>-->
   			 </div>

					<!-- 5'th Baby Planning Slide  -->
					<!--<div class="item">
						<a href="http://www.medgenomeclaria.com/planning-pregnancy/" target="_blank"><img src="<?php /*echo $site_path;*/?>/img/slider/5-min.jpg" class="img-responsive banner hidden-xs"></a>
						<a href="http://www.medgenomeclaria.com/planning-pregnancy/" target="_blank"><img src="<?php /*echo $site_path;*/?>/img/slider/M5-min.jpg" class="img-responsive banner visible-xs"></a>
					</div>-->

					<!-- 6'th Expecting Slide  -->
					<!--<div class="item">
						<a href="http://www.medgenomeclaria.com/expecting-parents/" target="_blank"><img src="<?php /*echo $site_path;*/?>/img/slider/6-min.jpg" class="img-responsive banner hidden-xs"></a>
						<a href="http://www.medgenomeclaria.com/expecting-parents/" target="_blank"><img src="<?php /*echo $site_path;*/?>/img/slider/M6-min.jpg" class="img-responsive banner visible-xs"></a>
					</div>-->

					<!-- 7'th Career Screening  -->
					<div class="item">
						<a href="https://providers.medgenomeclaria.com/" target="_blank"><img src="<?php echo $site_path;?>/img/slider/7-min.jpg" class="img-responsive banner hidden-xs"></a>
						<a href="https://providers.medgenomeclaria.com/" target="_blank"><img src="<?php echo $site_path;?>/img/slider/M7-min.jpg" class="img-responsive banner visible-xs"></a>
					</div>
			</div>
		</div>
	</div>
...
<div class="wrapper map-wrapper">
	<div class="container pad-space">
		...
		<div class="col-sm-12 map-2">
			...
			<p>MedGenome has ISO15189 compliant NGS lab in Foster City, California and two other state of art sequencing labs in Bangalore and Cochin</p>
			...
			<div class="panel-body mother-wrapper">
				...
				<div class="container banner-content banner-content2">
					<div class="row">
						...
						<div class="col-md-6" style="margin-top: 240px;"><div class="banners2"></div></div>
					</div>
				</div>
			</div>
		</div>
