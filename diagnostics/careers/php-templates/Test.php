                        ...
                        <ul  class="drop-down-menu ">
                            <li class="sub-drop-down clearfix"><a href="#">By Disease</a>
                                ...
                                <ul class="sub-drop-down-menu">
                                    ...
                                    <li><a href="<?php echo $site_path;?>/disease.php?act=connective-tissue-disorder">Tissue Disorder</a></li>
...
<div id="serviceSubMenu" class="container-fluid serviceSubMenu" style="display: none;" onmouseleave="subMenuHide()">
    <!--<div id="serviceSubMenu" class="container-fluid serviceSubMenu">-->
    <div class="row">
        <div class="col-md-8">
            <ul>
                <li><a class="serviceSubTitle" href="#">Next Generation Sequencing</a></li>
