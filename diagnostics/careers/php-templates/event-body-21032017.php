...
$date = [
	"April 6, 2017", "March 21, 2017", "March 20, 2017", "August 29 – September 2, 2016", "September 25-28, 2016", "September 26-28, 2016", "October 18-22, 2016", "October 20 - 23, 2016", "December 3-6, 2016", "December 6-10, 2016", "November 9-13, 2016",
					...
					<div class="tab-content">
						...
						?>
							<div class="main">
								...
								<?php if($i == "1"){?><a href="<?php echo $site_path;?>/symposium.php"  type="submit" style="color: #FFF; float: right;" name="btnsubmit" class="btn btn-info">Register</a><?php } ?>
									</p>
								</div>
							</div>
						<?php } } ?>
						...
						<div class="tab-pane fade" id="passedEvents">
							<?php for($i=0; $i < count($title); $i++){
								if(isset($event_type[$i]) && $event_type[$i] == "passedEvents"){
									?>
									<div class="main">
										<div class="left" >
											<h3><?php echo $left_title[$i]?></h3>
