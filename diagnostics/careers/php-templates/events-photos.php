...
<div class="row right">
  ...
  <div class="col-xs-12 col-md-8 text-center hvr-grow">
    <img src="<?php echo $site_path;?>/img/webinar/<?php echo $poster[$i];?>" alt="Poster-Whd" ng-click="detailedView('<?php echo $poster[$i];?>','<?php echo $title[$i];?>','<?php echo $title[$i];?>')"><br><br><?php echo $title[$i];?>
  </div>
  <?php } ?>
</div>
