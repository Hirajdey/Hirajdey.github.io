    ...
    <div ng-controller="ngCtrl">
            <div class="container year2016">
                ...
                <?php if((isset($_REQUEST['month'])) && ($_REQUEST['month'] == 'november') || (!isset($_REQUEST['month']))) { ?>
                    ...
                    <tr ng-click="additionalNews('october31','2016')" class="media-box1 <?php if($current_month == 'november') echo 'highlightmonth';?>" id="october312016">
                    ...
                    <tr ng-click="additionalNews('october27','2016')" class="media-box1 <?php if($current_month == 'november') echo 'highlightmonth';?>" id="october272016">
                        <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                        <td>27th Oct</td>
                    ...
                    <tbody id="october27pop" style="display: none;">
                    <?php
                    $image = [
                        "aapala.png",
                        "dainik.jpg",
                    ...
                    $url = [
                        ...
                        "$site_path/pdf/2016/23rdSepVishalSamachar2016.pdf",
                        "$site_path/pdf/2016/5thNovDeccanHerald2016.pdf",
                ...
                <?php if((isset($_REQUEST['month'])) && ($_REQUEST['month'] == 'october') || (!isset($_REQUEST['month']))) { ?>
                    ...
                    <tr ng-click="additionalNews('october13','2016')" class="media-box1 <?php if($current_month == 'november') echo 'hig hlightmonth';?>" id="october132016">
                        <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                        <td>13th Oct</td>
