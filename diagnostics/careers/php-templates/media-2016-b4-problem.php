                ...
                <table class="table main">
                    ...
                    <?php if((isset($_REQUEST['month']) && $_REQUEST['month'] == "august") || (!isset($_REQUEST['month']))){?>
                        ...
                        $pdf = [
                            ...
                            "Medgenome - Prabhu Rashtra - Kolkata"
                        ];
                        $url = [
                            "pdf/2016/Medgenome-Jansatta-Kolkata.jpg",
                            "pdf/2016/Medgenome-PrabhuRashtra-Kolkata.jpg"
                        ];
                    ...
                    <tr ng-click="additionalNews('april27','2016')" class="media-box1" id="april272016">
                        <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></td>
                        <td>27th Apr </td>
                    ...
                    <tr id="april27pop" style="display: none;">
                        <td></td>
                        <td>1</td>
                        <td><img src="<?php echo $site_path;?>/img/press/2016/times.jpg"></td>
                        <td><a href="<?php echo $site_path;?>/pdf/2016/The_Times_of_India_-Bhopal_Pg-no.03_26.04.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                        <td><a href="#" type="button" data-toggle="modal" data-target="#april27"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                    </tr>

                    <tr ng-click="additionalNews('april21','2016')" class="media-box1" id="april212016">
                        <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></td>
                        <td>21th Apr</td>
                    ...
                    <tbody id="april21pop" style="display: none;">
                        <tr>
                            <td></td>
                            <td>1</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/ap-herald.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/apherald.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="#"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>2</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/indian-express-small.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/NewIndianExpress.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="http://www.newindianexpress.com/prcorner/?doc=201604201036PR_NEWS_EURO_ND__enIN201604201309_indiapublic&dir=25" target="_blank"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>3</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/telegraph-logo.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/telegraphindia.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="http://www.telegraphindia.com/pressrelease/prnw/enin201604201309_indiapublic.html#.V2uXeKLQg8t" target="_blank"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>
                    </tbody>
                    ...
                    <?php if((isset($_REQUEST['month']) && $_REQUEST['month'] == "march") || (!isset($_REQUEST['month']))){?>
                        <tr ng-click="additionalNews('march08','2016')" class="media-box1" id="march082016">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></td>
                            <td>08th Mar</td>
                            <td>MedGenome and Narayana Nethralaya Organised a discussion on Genetics in Ophthamology</td>
                            <td>PDF</td>
                            <td>Source Link</td>
                        </tr>
                        <tr id="march08pop" style="display: none;">
                            <td></td>
                            <td>1</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/indian-express-1.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/newindianexpress_MedGenome_NN-ed.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="http://www.newindianexpress.com/prcorner/?doc=201603070144PR_NEWS_EURO_ND__enIN201603076890_indiapublic&dir=25" target="_blank"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>

                        <tr ng-click="additionalNews('march07','2016')"class="media-box1" id="march072016">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></td>
                            <td>07th Mar </td>
                        ...
                        <tr id="march07pop" style="display: none;">
                            <td></td>
                            <td>1</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/financialexpress_3.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/StartUp-India-Will-It-Lead-To-Stand-Up-India-%E2%80%93-The-Financial-Express.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="http://www.financialexpress.com/article/healthcare/cover-story-healthcare/startup-india-will-it-lead-to-stand-up-india/220568/" target="_blank"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>
                     <?php $i = 1; } ?>
                    ...
                    <tr id="feb29pop" style="display: none;">
                        ...
                        <tr ng-click="additionalNews('feb17','2016')"class="media-box1" id="feb172016">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></td>
                            <td>17th Feb</td>
                            <td>MedGenome Awarded With the_Bio-Excellence Award</td>
                            <td>PDF</td>
                            <td>Source Link</td>
                        </tr>

                        <tbody id="feb17pop" style="display: none;">
                        <tr>
                            <td></td>
                            <td>1</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/indian-express-1.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/PR_Corner_-_The_New_Indian_Express.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="http://www.newindianexpress.com/prcorner/?doc=201602170225PR_NEWS_EURO_ND__enIN201602174842_indiapublic&dir=25" target="_blank"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>2</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/telegraph-logo.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/MedGenome_Awarded_With_the_Bio-Excellence_Award_-_The_Telegraph.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="http://www.telegraphindia.com/pressrelease/prnw/enin201602174842_indiapublic.html#.V2umG6LQg8u" target="_blank"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>
                        </tbody>
                        ...
                        <tr ng-click="additionalNews('feb02','2016')"class="media-box1" id="feb022016">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></td>
                            <td>02th Feb</td>
                            <td>MedGenome teams up with KCHRC to set up molecular genetics lab</td>
                            <td>PDF</td>
                            <td>Source Link</td>
                        </tr>
                        <tr id="feb02pop" style="display: none;">
                            <td></td>
                            <td>1</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/ethealthword.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/MedGenome_teams_up_with_KCHRC_to_set_up_molecular_genetics_lab_-_ET_HealthWorld.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="http://health.economictimes.indiatimes.com/news/diagnostics/medgenome-teams-up-with-kchrc-to-set-up-molecular-genetics-lab/50819665" target="_blank"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>

                        <tr ng-click="additionalNews('feb01','2016')"class="media-box1" id="feb012016">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></td>
                            <td>01th Feb</td>
                            <td> KCHRC and MedGenome inaugurate molecular genetics laboratory in Gujarat </td>
                            <td>PDF</td>
                            <td>Source Link</td>
                        </tr>
                        <tr id="feb01pop" style="display: none;">
                            <td></td>
                            <td>1</td>
                            <td><img src="<?php echo $site_path;?>/img/press/2016/financialexpress_3.jpg"></td>
                            <td><a href="<?php echo $site_path;?>/pdf/2016/KCHRC_and_MedGenome_inaugurate_molecular_genetics_laboratory_in_Gujarat_____The_Financial_Express.pdf" target="_blank"><img src="<?php echo $site_path;?>/img/press/pdf-link-icon.jpg"></a></td>
                            <td><a href="http://www.financialexpress.com/article/healthcare/happening-now/kchrc-and-medgenome-inaugurate-molecular-genetics-laboratory-in-gujarat/205272/" target="_blank"><img src="<?php echo $site_path;?>/img/press/source-link-icon.jpg"></a></td>
                        </tr>
                    <?php $i = 1; } ?>
