            ...
            <div class="container">
                ...
                <table class="table main">
                    ...
                    <?php if((isset($_REQUEST['month']) && $_REQUEST['month'] == "november") || (!isset($_REQUEST['month']))){?>
                        ...
                        <tr ng-click="additionalNews('november09','2015')" class="media-box1" id="november092015">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                            <td>09th Nov</td>
                            <td width="70%">'It is the era of genomics and haematology', says Dr Mammen Chandy at Haematocon 2015</td>
                            <td>PDF</td>
                            <td>Source Link</td>
                        </tr>

                        <tbody id="november09pop" style="display: none;">
                        <?php
                        $image = [
                            "ethealthword.jpg"
                        ];
                        ...
                        <tr ng-click="additionalNews('november19','2015')" class="media-box1" id="november192015">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                            <td>19th Nov</td>
                            <td width="70%">Grish Mehta appointed as MedGenome India CEO</td>
                            <td>PDF</td>
                            <td>Source Link</td>
                        </tr>
                    ...
                    <?php if((isset($_REQUEST['month']) && $_REQUEST['month'] == "august") || (!isset($_REQUEST['month']))){?>
                        ...
                        <tr ng-click="additionalNews('august10','2015')" class="media-box1" id="august102015">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                            <td>10th Aug</td>
                            <td width="70%">Molecular genetics has a significant rolw to play in the clinical practice</td>
                            <td>PDF</td>
                            <td>Source Link</td>
                        </tr>

                        <tbody id="august10pop" style="display: none;">
                        <?php
                        $image = [
                            "ethealthword.jpg"
                        ];
                    ...
                    <?php if((isset($_REQUEST['month']) && $_REQUEST['month'] == "july") || (!isset($_REQUEST['month']))){?>
                        ...
                        <tr ng-click="additionalNews('july23','2015')" class="media-box1" id="july232015">
                            <td><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                            <td>23rd Jul</td>
                            <td width="70%">Sequoia Capital invests $20 mn in MedGenome</td>
                            <td>PDF</td>
                            <td>Source Link</td>
                        </tr>

                        <tbody id="july23pop" style="display: none;">
                        <?php
                        $image = [
                            "live-mint.png"
                        ];
