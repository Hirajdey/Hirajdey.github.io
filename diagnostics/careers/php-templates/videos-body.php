<div>
    ...
    <div class="container year2016" style="max-height: none;">
        ...
        $video_image = ["1.jpg", "2.jpg", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "9.jpg", "10.jpg", "11.jpg"];
        $video_title = [
...
genomic-research-dr-mullasari-ajit-s/59856060",
        ...
        <!--<div class="container">-->
            <div class="row text-center">
                <?php
                for($i = count($video_image)-1; $i >= 0; $i--){ ?>
                <div class="col-md-8 col-sm-12 videoimage">
                    <div><a href="<?php echo $video_link[$i];?>" class="hvr-bounce-in" target="_blank"><img src="<?php echo $site_path;?>/img/press/2017/videos/<?php echo $video_image[$i];?>" alt="<?php echo $i;?>"></a></div>
