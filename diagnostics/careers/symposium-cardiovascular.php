	...
	<div ng-app="symposiumApp">
		<div ng-controller="symposiumCtrl">
			...
			<div class="container symposium">
				...
				<div class="row">
					<div class="col-md-24">
						<h1>Symposium on Cardiovascular Disease on January 12, 2018 at MedGenome Foster City</h1><br>
					</div>
				</div>

				<div class="row row-eq-height">
					<div class="col-md-20 speach1">
						<b>Dr. Sekar Kathiresan</b>, Director of the Center for Genomic Medicine (CGM) at Massachusetts General Hospital (MGH)<br>
						<b>Topic:</b> Genes, lifestyle, and risk for heart attack
						<br><b>Time:</b> 4:00 pm - 5:00 pm PST, January 12, 2018
					</div>
				</div>
