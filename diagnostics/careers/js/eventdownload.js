...
eventApp.controller("eventCtrl", function ($scope, $http, $location, $modal, $rootScope, $uibModalStack, calculateService) {
...
angular.module('eventApp').controller('emailCtrl', function ($scope, $http, $modal, $rootScope, $modalInstance, $rootScope, calculateService, file, path, $window, act) {
        ...
        if (($scope.loginemail != '') && (typeof($scope.loginemail) != 'undefined') && ($scope.loginpassword != '') && (typeof($scope.loginpassword) != 'undefined')) {
            ...
            $http({
                ...
                if(response == 0){
                    ...
                    $scope.close();
                    $window.location.href = calculateService.getCurrentUrl() + "/events-download/?act=" + act;
...
angular.module('eventApp').controller('registerCtrl', function ($scope, $http, $modal, $rootScope, $uibModalStack, calculateService){
...
// factory
angular.module('eventApp').factory('calculateService', function(){
