...
$("#top_menu_cardiology").click(function () {
  $("#ca").show();
  for(var x=0; x< diseases_id.length; x++){
    if(diseases_id[x] != "ca")
      $("#"+diseases_id[x]).hide();
...
$("#top_menu_connective-tissue-disorder").click(function () {
  $("#ctd").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_dermatology").click(function () {
  $("#der").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_endocrinology").click(function () {
  $("#end").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_haematology").click(function () {
  $("#hae").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_immunology").click(function () {
  $("#imm").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_metabolic-disorders").click(function () {
  $("#met").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_miscellaneous").click(function () {
  $("#mis").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_nephrology").click(function () {
  $("#nep").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_neurology").click(function () {
  $("#neu").show();
  for(var x=0; x< diseases_id.length; x++){
...
$("#top_menu_oncology").click(function () {
  $("#onc").show();
  for(var x=0; x< diseases_id.length; x++){
