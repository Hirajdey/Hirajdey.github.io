...
<div class="management">
	<div ng-app="ngApp">
		<div class="wrapper about-wrapper-index visible-xs visible-sm visible-md visible-lg management" ng-controller="ngManagement">
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="row modal-body">
							<div class="col-md-6 management-image"><img alt="" src="<?php echo $site_path;?>/img/management/{{photo}}" width="150px" height="150px"></div>
							<div class="col-md-16 management-description">
								...
								<!-- Karthik -->
								<!--<div id="kartick" class="display-none">
									<p>Kartik has worked with multiple high tech startups in his career as an investor and early stage co-founder including Webex (acquired by Cisco) where he was an early founding employee. He has worked in private equity consulting at Boston Consulting Group in New York, and has been a hands on venture capital investor in several successful early stage technology companies in the US and India. Kartik’s undergraduate and master’s degrees are in Astrophysics undertaking research in solar neutrinos at Oxford University, before switching fields and completing his PhD at the London School of Economics as an Interdisciplinary Scholar for his applied mathematical research on scientific labor markets. He is currently also a Visiting Fellow at MIT.</p>
								</div>-->

								<!-- Grish -->
								<div id="grish" class="display-none">
									<p>An alumnus of IIT Bombay and IIM Kolkata, Girish has over 25 years of rich corporate experience, and has held leadership positions across almost all key sectors of healthcare including pharmaceuticals, diagnostic services, diagnostic instrumentation and consumables, medical consumables and hospitals. His rich understanding of these sectors comes from his hands-on experience of establishing, building and turning-around organizations and businesses in this sector, some of which include Tata Strategic Management Group, Ajay Piramal Group, Thermo Fisher Scientific and Beams Hospital. His most recent assignment was with Oncquest Laboratories and DCA Imaging as Group CEO.</p>
								</div>
								...
								<div id="michael" class="display-none">
									<p>Michael's over 25 years of executive leadership experience has been focused on successfully growing several prominent life science companies. His expertise extends through general management, marketing, business development and sales in complex international businesses. He comes with a depth of understanding in Genomics, DNA Sequencing, Drug Discovery, Cell Biology, Immunology, Proteomics and Microbiome Analysis and has strong relationships within pharmaceutical, biotech, industrial and academic markets.</p>
								</div>

								<!-- Kamil -->
								<div id="kamil" class="display-none">
									<p>Ex-CEO of CIPLA.</p>
									<p>A pharmaceutical senior executive with experience in international business and strategic planning.</p>
								</div>

								<!-- Tariq -->
								<div id="tariq" class="display-none">
									<p>Dr. Tariq Arshad has 20 years of experience in the biotechnology and pharmaceutical industry in roles of successively increasing responsibility at blue-chip companies like Pfizer, Merck and Genentech. He has worked on successful global launches for $500M+ products at these companies and is deeply experienced in early- and late-stage asset management, commercial pipeline strategy, medical affairs/ KOL development and global brand planning. He holds an MD from Allama Iqbal Medical College with training in adult and paediatric oncology (including USMLE/ ECFMG certification), an MBA from George Washington University and global health training from Yale University.</p>
								</div>
			...
			<!-- Rearrange -->
			<div class="container">
				<div class="row"><div class="col-md-6"><h4>Management</h4></div></div>
					<div class="col-xs-0 col-md-6"></div>
					<div class="col-xs-24 col-md-24 photo hvr-grow">
						<img width="167px" height="157px" alt="Sam Santhosh" src="<?php echo $site_path;?>/img/management/Sam.jpg" ng-click="detailedView('Sam.jpg','Sam Santhosh – Founder and Chairman','sam')">
						<span class="name"><br>Sam Santhosh </span><br><span class="designation">Founder and Chairman</span>
					</div>
					<!--<div class="col-xs-12 col-md-6 photo hvr-grow">
						<img width="167px" height="157px" alt="Kartik Kumaramangalam " src="<?php /*echo $site_path;*/?>/img/management/Kartick.jpg" ng-click="detailedView('Kartick.jpg','Kartik Kumaramangalam (PhD) – Chief of Global Products and Services','kartick')">
						<span class="name"><br>Kartik Kumaramangalam (PhD) <br><span class="designation"> Chief of Global Products and Services</span>
					</div>-->
					<div class="col-xs-0 col-md-6"></div>
				</div>
				...
				<div class="row top">
					...
					<div class="col-md-12">
								<div class="row left">
									<div class="col-xs-12 col-md-12 photo hvr-grow">
										<img width="167px" height="157px" alt="Amitabha Chaudhuri" src="<?php echo $site_path;?>/img/management/Amit.jpg" ng-click="detailedView('Amit.jpg','Dr. Amitabha Chaudhuri – VP, Research & Development','amit')">
										<span class="name"><br>Dr. Amitabha Chaudhuri <br><span class="designation"> VP, Research & Development</span>
									</div>
									<div class="col-xs-12 col-md-12 photo hvr-grow">
										<img width="167px" height="157px" alt="Michael Nemzek" src="<?php echo $site_path;?>/img/management/Michael-Nemzek.jpg" ng-click="detailedView('Michael-Nemzek.jpg','Michael Nemzek – Chief Commercial Officer, USA','michael')">
								...
								<div class="row">
									<!-- Timothy J. Triche -->
									<div class="col-xs-12 col-md-12 photo hvr-grow">
										<img width="167px" height="157px" alt="Timothy J. Triche" src="<?php echo $site_path;?>/img/management/Timothy.jpg" ng-click="detailedView('Timothy.jpg','Dr. Timothy J. Triche – Laboratory Director','tim')">
										<span class="name"><br>Dr. Timothy J. Triche<br><span class="designation"> Laboratory Director </span>
									</div>
									<!-- Girish Mehta -->
									<div class="col-xs-12 col-md-12 photo hvr-grow">
										<img width="167px" height="157px" alt="Girish Mehta" src="<?php echo $site_path;?>/img/management/Girish-Mehta.png" ng-click="detailedView('Girish-Mehta.png','Girish Mehta – CEO (India)','grish')">
								...
								<div class="row">
									<!-- Hiranjith -->
									<div class="col-xs-12 col-md-12 photo hvr-grow">
										<img width="167px" height="157px" alt="Hiranjith G H" src="<?php echo $site_path;?>/img/management/Hiran.jpg" ng-click="detailedView('Hiran.jpg','Hiranjith G H – Director, Corporate Planning, Marketing & Communications','hiran')">
										<span class="name"><br>Hiranjith G H <br><span class="designation"> Director, Corporate Planning, Marketing & Communications</span>
									</div>
									<!-- Arati Khanna Gupta -->
									<div class="col-xs-12 col-md-12 photo hvr-grow">
										<img width="167px" height="157px" alt="Arati Khanna Gupta" src="<?php echo $site_path;?>/img/management/Arati.jpg" ng-click="detailedView('Arati.jpg','Dr. Arati Khanna Gupta – VP, Research & Development (India)','arati')">
										<span class="name"><br>Dr. Arati Khanna Gupta <br><span class="designation"> VP, Research & Development (India)</span>
									</div>
					...
					<div class="col-md-12">
						<div class="row right">
							<!-- Kamil Hamied -->
							<div class="col-xs-12 col-md-12 photo hvr-grow">
								<img width="167px" height="157px" alt="Kamil Hamied" src="<?php echo $site_path;?>/img/management/Kamil-Hamied.jpg" ng-click="detailedView('Kamil-Hamied.jpg','Kamil Hamied - International Business Development Consultant','kamil')">
								<span class="name"><br>Kamil Hamied <br><span class="designation">International Business Development Consultant</span>
							</div>

							<!-- V L Ramprasad -->
							<div class="col-xs-12 col-md-12 photo hvr-grow">
								<img width="167px" height="157px" alt="V L Ramprasad" src="<?php echo $site_path;?>/img/management/Ram.jpg" ng-click="detailedView('Ram.jpg','Dr. V L Ramprasad – COO','ram')">
						...
						<div class="row">
							<!-- Rohit Gupta -->
							<div class="col-xs-12 col-md-12 photo hvr-grow">
								<img width="167px" height="157px" alt="Rohit Gupta" src="<?php echo $site_path;?>/img/management/Rohit.jpg" ng-click="detailedView('Rohit.jpg','Dr. Rohit Gupta – CIO','rohit')">
								<span class="name"><br>Dr. Rohit Gupta <br><span class="designation"> CIO</span>
							</div>
							<!-- Surajit Chakrabartty -->
							<div class="col-xs-12 col-md-12 photo hvr-grow">
								<img width="167px" height="157px" alt="Surajit Chakrabartty" src="<?php echo $site_path;?>/img/management/Surajit.jpg" ng-click="detailedView('Surajit.jpg','Surajit Chakrabartty – CFO','surajit')">
						...
						<div class="row">
							<!-- Sanjay Kumar Sharma -->
							<div class="col-xs-12 col-md-12 photo hvr-grow">
								<img width="167px" height="157px" alt="Sanjay Kumar Sharma" src="<?php echo $site_path;?>/img/management/Sanjay.jpg" ng-click="detailedView('Sanjay.jpg','Sanjay Kumar Sharma – CCO','sanjay')">
								<span class="name"><br>Sanjay Kumar Sharma <br><span class="designation"> CCO</span>
							</div>
							<!-- Chirantan Bose -->
							<div class="col-xs-12 col-md-12 photo hvr-grow">
								<img width="167px" height="157px" width="150px" height="150px"  alt="Chirantan Bose" src="<?php echo $site_path;?>/img/management/Chirantan-Bose.jpg" ng-click="detailedView('Chirantan-Bose.jpg','Dr. Chirantan Bose – VP, Clinical Services','bose')">
								<span class="name"><br>Dr. Chirantan Bose <br><span class="designation"> VP, Clinical Services</span>
							</div>
						</div>
						...
						<div class="row">
							<!-- Tariq Arshad -->
							<div class="col-xs-12 col-md-12 photo hvr-grow">
								<img width="167px" height="157px" alt="Tariq Arshad" src="<?php echo $site_path;?>/img/management/Tariq-Arshad.png" ng-click="detailedView('Tariq-Arshad.png','Dr. Tariq Arshad – Chief Medical Officer (Immuno-Oncology)','tariq')">
								<span class="name"><br>Dr. Tariq Arshad <br><span class="designation"> Chief Medical Officer (Immuno-Oncology)</span>
							</div>

							<div class="col-xs-12 col-md-12 photo"></div>
						</div>
					</div>
					<!-- End Right -->
				</div>
