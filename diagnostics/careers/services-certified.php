    ...
    <div class="webinar" ng-app="eventApp">
        <div ng-controller="eventCtrl">
            <div class="container oncopeptEvents">
                ...
                <h4 class="page-title">CAP / CLIA Certified Services</h4>
            ...
            <div class="container" id="exomeSection" style="display: none">
                <div class="tab-pane fade in" id="tab1info"><?php include('services/certified-exomesequencing.php');?></div>
            </div>
            <!-- Whole Genome Sequencing -->

            <!-- RNA Sequencing -->
            <div class="container" id="rnsSection" style="display: none">
                    <?php include('services/certified-rnasequencing.php');?>
            </div>
            <!-- RNA Sequencing -->
            
             <!-- Panel Sequencing -->
            <div class="container" id="panelSection" style="display: none">
                    <?php include('services/certified-panelsequencing.php');?>
            </div>
            <!-- Panel Sequencing -->
