...
<div class="partner-baner inner-banner" id="page-one">
	<div class="container full-height">
		<div class="row">
			<div class="head-row col-sm-24">
				<nav class="navbar navbar-default">
				    ...
				    <div class="navbar-header">
						...
						<ul class="left-margn nav navbar-nav col-md-15">
                                    ...
                                    <li><a href="<?php echo $site_path;?>/oncomdpartner.php" class="active">Partners</a></li>
				...
				<h3>
				OncoMD can be integrated with commercial next generation sequencing data analysis platforms to offer additional annotations of cancer mutations to enhance the value of our partners’ offerings
				</h3>
			</div>			
...
<div class="partner-info col-sm-24" id="page-two">
	<div class="container">
		<h4>What our partners’ are saying </h4>
	</div>
</div>
<div class="partner-content col-sm-24">
		<div class="container">			
			<div class="col-sm-24 col-lg-8">
				<div class="box-col">
					<h2>Andreas Scherer</h2>
					<h3>Golden Helix, President & CEO</h3>
					<p>Providing VarSeq users with access to OncoMD, allows clinicians to better tailor
					diagnostic and therapeutic strategies to individual patients</p>
					<a class="btn btn-primary" href="http://goldenhelix.com/News/pressrelease20150527OncoMD.html" target="_blank">Read More</a>
					<div class="sponser"><img src="<?php echo $site_path;?>/img/oncomd/logo/sponser-1.png" alt=""></div>
				</div>	
			</div>
			<div class="spn-two col-sm-24 col-lg-8">
				<div class="box-col">
					<h2>Mark Kaganovich</h2>
					<h3>SolveBio, Co-founder</h3>
					<p>The quality of OncoMD’s curated data is unrivaled in the oncology space and we're excited to make OncoMD more accessible than ever before to developers of genomic tests and clinicians</p>
					<a class="btn btn-primary" href="https://www.genomeweb.com/informatics/solvebio-medgenome-ink-data-distribution-agreement" target="_blank">Read More</a>
					<div class="sponser sponser-two"><img src="<?php echo $site_path;?>/img/oncomd/logo/sponser-2.png" alt=""></div>
				</div>	
			</div>
			<div class="spn-three col-sm-24 col-lg-8">
				<div class="box-col">
					<h2>Herman Verrelst</h2>
					<h3>Cartagenia, CEO</h3>
					<p>It is important for our customers to have tools like OndoMD to help them analyze and assess the genetic profile of their patients</p>
					<a class="btn btn-primary" href="http://www.prnewswire.com/news-releases/cartagenia-partners-with-medgenome-to-provide-pathology-laboratories-access-to-extensive-cancer-variant-knowledge-base-300024053.html" target="_blank">Read More</a>
					<div class="sponser sponser-three"><img src="<?php echo $site_path;?>/img/oncomd/logo/sponser-3.png" alt=""></div>
				</div>
			</div>
		</div>
