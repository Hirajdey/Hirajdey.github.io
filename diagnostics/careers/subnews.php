...
if(isset($_REQUEST['month']) || isset($_REQUEST['year'])) {
    ...
    //echo "SELECT * FROM media_news WHERE ". $month_query . $year_query. " AND status = 1 ORDER BY news_date DESC"; exit;
    ...
    $media_news = $conn->query("SELECT * FROM media_news WHERE ". $month_query . $year_query. " AND status = 1 ORDER BY news_date DESC");
