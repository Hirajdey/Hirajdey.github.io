            ...
            <div class="container">
                ...
                <?php if((isset($_REQUEST['month'])) && ($_REQUEST['month'] == 'october')) { ?>
                    ...
                    $url = [
                        ...
                        "http://www.indiannewsandtimes.com/2016/10/12/medgenome-becomes-first-genomics-firm-south-east-asia-acquire-high-throughput-illumina-hiseq-x-ten-platform/",
                    ...
                    $url = [
                        "http://menafn.com/1095002404/MedGenome-becomes-first-genomics-firm-in-South-East-Asia-to-acquire-high-throughput-Illumina-Hiseq-X-Ten-platform"
                    ];
                    for($i=0; $i<count($image); $i++){
                        ?>
                        <tr>
