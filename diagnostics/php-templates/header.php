	...
	<!--<h1>Web Pack Test</h1>-->
		...
		<div class="header-flag-section">
			<div class="container-fluid top-second hidden-xs">
				...
				<!--<div class="col-md-7 col-sm-15 col-lg-11 cap-logo">
					<img src="<?php /*echo $site_path;*/?>/img/logo/cap-logo.jpg">
				</div>-->
		...
		<!--<div class="wrapper nav-section1">-->
  		<div class="wrapper nav-section1" ng-mouseleave="hideServiceSubMenu()">
			<div class="container">
				<div class="logo visible-xs"><a href="<?php echo $site_path;?>/index"><img src="<?php echo $site_path;?>/img/logo/logo.png" alt="Medgenome Logo"></a></div>
				...
				<!--<div class="row">
					<div class="col-xs-24 text-center visible-xs">
						<img src="<?php /*echo $site_path;*/?>/img/logo/cap-logo-mobile-version.jpg" alt="Cap Logo">
					</div>
				</div>-->
