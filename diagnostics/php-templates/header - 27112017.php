				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav hidden-xs hidden-sm">
							...
							<!--<li class="drop-down">
								<a href="<?php /*echo $site_path;*/?>/service" onmouseover="subMenuShow();">Services</a>-->
								<!--<ul class="drop-down-menu">
									<li class="sub-drop-down clearfix">
										<a href="#">Genomic Solutions</a>
										<span class="glyphicon glyphicon-menu-right"></span>
										<ul class="sub-drop-down-menu">
											<li><a href="<?php echo $site_path;?>/oncomd">OncoMD</a></li>
											<li><a href="<?php echo $site_path;?>/oncopept">OncoPept</a></li>
										</ul>
									</li>
                                    <li><a href="#">Next Generation Sequencing</a></li>
									<li><a href="<?php echo $site_path;?>/ngs">NGS Informatics</a></li>
                            ...
                            <!--<li class="drop-down"><a href="#" onmouseover="subMenuHide()">Research</a>
								<ul class="drop-down-menu ">
									<li><a href="<?php echo $site_path;?>/disease-program">Disease Programs</a></li>
									<li><a href="<?php echo $site_path;?>/integratedgenomicsplatform">Integrated Genomics Platform</a></li>
                                    <li><a href="http://genomeasia100k.com/" target="_blank">GenomeAsia 100K</a></li>
									<li><a href="<?php echo $site_path;?>/computational-biology">Computational Biology</a></li>
								</ul>
							</li>

                            <li><a href="<?php echo $site_path;?>/publications" onmouseover="subMenuHide()">Publications</a></li>
						</ul>
						...
						<ul class="nav navbar-nav visible-xs visible-sm">
                            ...
                            <!--<li class="drop-down">
                              ...
                              <li class="clearfix"><a href="#">Next Generation Sequencing</a>
                                  <ul class="sub-drop-down-menu">
                                     <li><a href="<?php /*echo $site_path;*/?>/servicestypes?act=genome">Whole Genome Sequencing</a></li>
                              ...
                              <li class="clearfix"><a href="<?php /*echo $site_path;*/?>/ngs">NGS Bioinformatics</a></li>
							...
							<!--<li class="visible-xs visible-sm">
								<a href="<?php /*echo $site_path;*/?>/service">Immunotherapy Solutions</a>
								<ul class="mob-submenu">
									<li><a href="<?php /*echo $site_path;*/?>/oncomd">OncoMD</a></li>
									<li><a href="<?php /*echo $site_path;*/?>/oncopept">OncoPept</a></li>
								</ul>
                            ...
                            <li class="visible-xs visible-sm">
								...
								<ul class="mob-submenu">
									...
									<li><a href="<?php /*echo $site_path;*/?>/integratedgenomicsplatform">Integrated Genomics Platform</a></li>
                                    <li><a href="http://genomeasia100k.com/" target="_blank">GenomeAsia 100K </a></li>
									<li><a href="<?php /*echo $site_path;*/?>/disease-program">Computational Biology</a></li>
								</ul>
							</li>-->
