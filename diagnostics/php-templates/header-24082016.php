...
<html lang="en">
	<head>
		...
		$index = [
			...
			"description"=>"Market leader for genetic diagnostic testing and genomics research company in India",
...
<!-- jQuery Star-->
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav hidden-xs hidden-sm">
							...
							<!-- Service Menu -->
							<li id="serviceMenu"><a href="#" onmouseover="subMenuShow();">Services</a></li>
							<!-- End -->

							<li class="drop-down"><a href="#" onmouseover="subMenuHide()">Clinical Genomics</a>
								<ul  class="drop-down-menu ">
									...
									<li><a href="http://medgenome.com/panorama/" target="_blank">Non-Invasive Prenatal Test</a></li>
								</ul>
							</li>
							<li class="drop-down">
								<a href="<?php echo $site_path;?>/service.php" onmouseover="subMenuHide()">Genomic Research Services</a>
								<ul class="drop-down-menu">
							...
							<li><a href="http://genomeasia100k.com/" target="_blank" onmouseover="subMenuHide()">GenomeAsia 100K </a></li>
		...
		<div id="serviceSubMenu" class="container-fluid serviceSubMenu" style="display: none;" onmouseleave="subMenuHide()">
				<div class="row">
					<div class="col-md-8">
						<ul>
							<li><a class="serviceSubTitle" href="#">Next Generation Sequencing</a></li>
							<li><a class="serviceSubText" href="#">Tissue Disorders</a></li>
							<li><a class="serviceSubText" href="#">Whole Genome Sequencing</a></li>
							<li><a class="serviceSubText" href="#">Whole Exome Sequencing</a></li>
							<li><a class="serviceSubText" href="#">RNA Sequencing</a></li>
							<li><a class="serviceSubText" href="#">miRNA Sequencing</a></li>
							<li><a class="serviceSubText" href="#">ChIP Sequencing</a></li>
							<li><a class="serviceSubText" href="#">MethylSeq</a></li>
						</ul>
					</div>
					<div class="col-md-8">
						<ul>
							<li><a class="serviceSubTitle" href="#">NGS Bioinformatics</a></li>
							<li><a class="serviceSubTitle" href="#">Cloning & Stable Cell Line Development</a></li>
						</ul>
					</div>
					<div class="col-md-8">
						<ul>
							<li><a class="serviceSubTitle" href="#">CAP / CLIA Certified Services</a></li>
							<li><a class="serviceSubText" href="#">Exome Sequencing</a></li>
							<li><a class="serviceSubText" href="#">RNA Sequencing</a></li>
							<li><a class="serviceSubText" href="#">Panel Sequencing</a></li>
						</ul>
					</div>
				</div>
			</div>
