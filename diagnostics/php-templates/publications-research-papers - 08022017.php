  ...
  <div class="col-md-24">
    <table class="table table-striped">
      ...
      <tr>
        ...
        <td class="text-center"><a href="<?php echo $site_path;?>/download.php?download_file=<?php echo $file[$i];?>&path=<?php echo $path;?>"><img class="download-image" src="<?php echo $site_path;?>/img/icons/icon-download.png"></a></td></td>
      </tr>
      <?php } ?>
      </tbody>
    </table>
