...
<html lang="en">
	...
	<div class="header-flag-section">
		<div class="container-fluid top-second hidden-xs">
			<div class="col-md-12 col-sm-8 logo">
			...
			<div class="col-md-12 col-sm-16 contact text-right">
				<!--<ul>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-4 flag-border"><img src="<?php echo $site_path;?>/img/home/india-flag.png" alt="india flag"></div>
							<div class="col-md-20 text-left">
								<div class="row">
									<div class="col-md-24 mailid"><img src="<?php echo $site_path;?>/img/home/mail.png" alt="mail icon">diagnostics@medgenome.com</div>
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-3 flag-border"><a href="https://medgenome.com"><img src="<?php echo $site_path;?>/img/home/us-flag.png" alt="india flag"></a></div>
							<div class="col-md-20 text-left">
								<div class="row">
									<div class="col-md-24 mailid"><img src="<?php echo $site_path;?>/img/home/mail.png" alt="mail icon">research@medgenome.com</div>
									<div class="col-md-24 toll-free-number"><img src="<?php echo $site_path;?>/img/home/phone.png" alt="phone icon">(888) 440-0954</div>
								</div>
							</div>
						</div>
					</div>
		...
		<!--<div class="wrapper nav-section1">-->
  		<div class="wrapper nav-section1" ng-mouseleave="hideServiceSubMenu()">
			...
			<div class="mobile-top-contactus visible-xs visible-sm">
				<div class="row">
					<div class="col-xs-6 text-right"><img src="<?php echo $site_path;?>/img/home/india-flag.png" alt="india flag"></div>
					<div class="col-xs-18">
						<div class="row">
							<div class="col-sm-24"><img src="<?php echo $site_path;?>/img/home/mail.png" alt="mail icon"> diagnostics@medgenome.com</div>
							<div class="col-sm-24 toll-free-number"><img src="<?php echo $site_path;?>/img/home/phone.png" alt="phone icon">1800 103 3691</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-6 text-right"><img src="<?php echo $site_path;?>/img/home/us-flag.png" alt="india flag"></div>
					<div class="col-xs-18">
						<div class="row">
							<div class="col-sm-24"><img src="<?php echo $site_path;?>/img/home/mail.png" alt="mail icon"> research@medgenome.com</div>
							<div class="col-sm-24 toll-free-number"><img src="<?php echo $site_path;?>/img/home/phone.png" alt="phone icon">(888) 440-0954</div>
						</div>
					</div>
				</div>
			</div>
