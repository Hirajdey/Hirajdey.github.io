...
<html lang="en">
	...
	<body>
		...
		<div class="container top-second hidden-xs">
			...
			<div class="col-md-10 ad hidden-xs hidden-sm hidden-md"><a href="http://www.prnewswire.co.uk/news-releases/medgenome-singapore-announces-whole-genome-sequencing-grant-challenge-for-south-east-asia-607409976.html" target="_blank"><img src="<?php echo $site_path;?>/img/ad/ad.jpg" alt="Whole Genome Sequencing Grant Challenge for South East Asia"></a></div>
