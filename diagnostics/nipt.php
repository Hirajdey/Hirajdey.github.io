...
<div id="claria-banner" class="banner">
	...
	<div class="bannerContent">
		<div class="wrapper">
			...
			<a href="<?php //echo $site_path;?>claria-testlist.php">View test catalog</a>
		</div>
	</div>
</div>
<!-- Actia banner -->
<div id="actia-banner" class="banner">
	...
	<div class="bannerContent">
		<div class="wrapper">
			...
			<a href="<?php //echo $site_path;?>actia-testlist.php">View test catalog</a>
		</div>
	</div>
</div>
<!-- Prima banner -->
<div id="prima-banner" class="banner">
	...
	<div class="bannerContent">
		<div class="wrapper">
			...
			<a href="<?php //echo $site_path;?>prima-testlist.php">View test catalog</a>
		</div>
	</div>
</div>
<div class="homeTab">
	<div class="wrapper">
  	...
  	<div id="tabs-1" class="diganosticsCont inner">
  		<a class="fixedViewTestCat" href="claria-testlist.php">View test catalog</a>
		...
		<a name="T10"/>
	  	<div id="T10" class="diganosticsInnerContent">
	  		...
	  		<div class="diganosticsInnerText five-simple-steps pl-4">
				...
				<div class="col-lg">
					<div class="row pt-3">
						<div class="col-sm|md|lg|xl pl-3"><div class="number">1.</div></div>
				...
				<div class="col-lg">
					<div class="row pt-3 mt-3 border-top">
						<div class="col-sm|md|lg|xl pl-3"><div class="number">2.</div></div>
				...
				<div class="col-lg">
					<div class="row pt-3 mt-3 border-top">
						<div class="col-sm|md|lg|xl pl-3"><div class="number">3.</div></div>
				...
				<div class="col-lg">
					<div class="row pt-3 mt-3 border-top">
						<div class="col-sm|md|lg|xl pl-3"><div class="number">4.</div></div>
				...
				<div class="col-lg">
					<div class="row pt-3 mt-3 border-top">
						<div class="col-sm|md|lg|xl pl-3"><div class="number">5.</div></div>
