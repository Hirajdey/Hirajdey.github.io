...
<nav class="navbar navbar-default navbar-fixed-top header">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav menu">
            ...
            <li><a href="<?php echo $site_path;?>/press">Press</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12 index-page-body">
            <div id="diagnostics" class="diagnostics">
                ...
                <div class="learn-more"><a href="https://diagnostics.medgenome.com/claria.php">LEARN MORE >></a></div>
                <!--<div class="logos">
...
<script>
    ...
    $( "#diagnostics" ).click(function() {
        window.location.href = "https://diagnostics.medgenome.com/claria.php";
    });
</script>
</body>
</html>
